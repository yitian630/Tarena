...
//任意方向摇杆 的 Delegate
class RockerDelegate_Custom{
public:
    virtual void touchBegan_cus(CCObject *rocker, CCPoint normalizer) = 0;
    virtual void touchMove_cus(CCObject *rocker, CCPoint normalizer) = 0;
    virtual void touchEnd_cus(CCObject *rocker) = 0;
};
...
public:
    ...
    CC_SYNTHESIZE(RockerDelegate_Custom*, m_delegate_Custom, Delegate_Custom);

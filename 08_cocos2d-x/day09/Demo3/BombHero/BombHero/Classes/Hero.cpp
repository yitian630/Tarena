...
bool Hero::init() {
    ...
    //添加将要死亡动画
    this->addWillDieAnimate("down1.png");
    
    
    //设置角色碰撞矩形
    this->setCollisionArea(CCRectMake(-20, 0, 40, 40));
    
    return true;
}

//创建一个动画对象
CCAnimate* Hero::createAnimate(const char *spriteFramName, int frameCount, int Loops){

...
//    NSString *path = @"https://open.t.qq.com/api/statuses/home_timeline?format=json&accesstoken=254847beee16b1d08d97ad5eeac84d72&appkey=801459107&appsecret=45e8fda363de618b07aeebf6b9919174";
//    NSString *str = [NSString stringWithContentsOfURL:[NSURL URLWithString:path] encoding:NSUTF8StringEncoding error:Nil];
//    NSLog(@"%@",str);
...
- (void)DidAuthRefreshed:(WeiboApiObject *)wbobj
{
    ...
    //UISwitch
    NSString *str = [[NSString alloc]initWithFormat:@"accesstoken = %@& openid = %@& appkey=%@&appsecret=%@\r",wbobj.accessToken, wbobj.openid, wbobj.appKey, wbobj.appSecret];

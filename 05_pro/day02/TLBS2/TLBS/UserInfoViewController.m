...
- (void)viewDidLoad
{
    ...
    [[TRMyWeiboApi shareWeiboApi] requestWithParams:params  apiName:@"user/info" httpMethod:@"GET" delegate:self];
...
- (void)didReceiveRawData:(NSData *)data reqNo:(int)reqno{
    ...
    self.userInfo = [WeiboPaser paseUserInfoByDictionary:userInfoDic];

...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TRPhotoListViewController *detailViewController = [[TRPhotoListViewController alloc] initWithNibName:@"TRPhotoListViewController" bundle:nil];

    // Pass the selected object to the new view controller.
    detailViewController.album = self.albums[indexPath.row];

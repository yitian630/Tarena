...
- (void)addPersonAction{
    ...
    //因为下个页面要往数据源里面添加数据 所以需要把数据源传递进去
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TRPersonInfoViewController *detailViewController = [[TRPersonInfoViewController alloc] initWithNibName:@"TRPersonInfoViewController" bundle:nil];
    //点击编辑跳转页面 在新页面中需要显示原来的数据 所以需要把原来的Person传递过去
    
    detailViewController.editPerson = p;
